...
class InvitationActivity : Layout() {

    private fun getInvitationAndDisplay() {
        val self = this
            ...
            override fun success(obj: Any?) {
                ...
                Request.getInstance().send(self, "users/${user.id}/invitations", "GET", JSONObject(), JSONObject(), object: Callback() {
                    override fun success(obj: Any?) {
                        ...
                        findViewById<GridView>(R.id.invitation_list).adapter = InvitationArrayAdapter(self, invitations, true)
                    }
                })
            }
        })
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState, R.layout.activity_invitation, false)

        getInvitationAndDisplay()
    }
}
